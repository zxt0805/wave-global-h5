 ...
 * @LastEditTime: 2022-10-10 17:37:09
    ...
    if (collectionInfo.sell_status == 0) {
      ...
      return (
        <div className="fixBottom">
          ...
          <div className={collectionInfo.sell_start_time - collectionInfo.system_time < 600 ? 'button button-disable' : 'button'} onClick={collectionInfo.sell_start_time - collectionInfo.system_time < 600 ? (() => {}) : addToCalendar}>
            {t('ADDTOCALENDAR')}
          </div>
        </div>
      )
